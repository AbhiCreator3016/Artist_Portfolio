...
const ArtistBio = () => {
  return (
    <section className="section-padding w-[100%] overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              Michael Anderson is a contemporary painter whose work explores the
              intersection of abstract expressionism and figurative art. With
              over two decades of experience, his paintings have been exhibited
              in galleries across Europe and North America.
            </p>

            <p className="text-gray-700 mb-6">
              Born in Boston and educated at the Rhode Island School of Design,
              Michael's distinctive style combines bold brushwork with subtle
              color harmonies, creating pieces that evoke both emotional depth
              and visual intrigue.
            </p>
